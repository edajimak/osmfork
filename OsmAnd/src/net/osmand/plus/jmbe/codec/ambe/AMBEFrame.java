...
import net.osmand.plus.jmbe.binary.BinaryFrame;
import net.osmand.plus.jmbe.codec.FrameType;
import net.osmand.plus.jmbe.edac.Golay23;
import net.osmand.plus.jmbe.edac.Golay24;
 ...
 */
public class AMBEFrame implements FrameInterface
{
    ...
    public BinaryFrame mFrame;
    public AMBEFundamentalFrequency mFundamentalFrequency;
    public FrameType mFrameType;
    public int[] mErrors = new int[2];
    public Tone mTone;
    public int mToneAmplitude;
    public int[] mB;
    public BinaryFrame vectorC0;
    public BinaryFrame vectorC1;
    public BinaryFrame vectorC2;
    public BinaryFrame vectorC3;
     ...
     */
    public AMBEFrame(byte[] frame, IAudioDecoder decoder)
    {
    ...
    public AMBEFrame(byte[] frame, boolean init)
    {
        mFrame = BinaryFrame.fromBytes(frame, ByteOrder.LITTLE_ENDIAN);
        if (init) {
            applyFEC();
    ...
    public AMBEFrame(byte[] frame)
    {
        ...
        vectorC0 = mFrame.getSubMessage(0, 12);
        vectorC1 = mFrame.getSubMessage(12, 24);
        vectorC2 = mFrame.getSubMessage(24, 35);
        vectorC3 = mFrame.getSubMessage(35, 49);
    }
     ...
     */
    public AMBEFrame(String hexString, boolean applyFEC)
    {
    ...
    public void applyFEC()
    {
        vectorC0 = getVector(VECTOR_C0);
        vectorC1 = getVector(VECTOR_C1);
        vectorC2 = getVector(VECTOR_C2);
        vectorC3 = getVector(VECTOR_C3);
    ...
    public static AMBEFrame fromMbeByte(byte[] frame)
    {
        AMBEFrame ambe = new AMBEFrame(frame, false);
        ambe.vectorC0 = ambe.mFrame.getSubMessage(0, 12);
        ambe.vectorC1 = ambe.mFrame.getSubMessage(12, 24);
        ambe.vectorC2 = ambe.mFrame.getSubMessage(24, 35);
        ambe.vectorC3 = ambe.mFrame.getSubMessage(35, 49);
     ...
     */
    public void decode(IAudioDecoder decoder)
    {
